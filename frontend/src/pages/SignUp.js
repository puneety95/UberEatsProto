  ...
  function SignUpHandler(e) {
    ...
    axios({
      ...
      .then((response) => {
        ...
        const signUpUserDetails = bindActionCreators(
          signUpGetUserDetails,
          dispatch
        );
          ...
          <Row>
            <div className="col-sm-2 col-ms-4 offset-sm-3 ">
              <Form style={{ marginTop: "6%" }} id="customer_signup">
                ...
                <input
                  onChange={(e) => {
                    set_signup_name(e.target.value);
                  }}
                ...
                <input
                  onChange={(e) => {
                    set_signup_pass(e.target.value);
                  }}
                  style={{ marginBottom: "8%" }}
                  type="password"
                  name="custlabel"
            ...
            <div className="col-sm-2 col-ms-4 offset-sm-3 ">
              <Form style={{ marginTop: "6%" }} id="customer_signup">
                ...
                <input
                  ...
                  set_signup_passstyle={{ marginBottom: "8%" }}
                  type="text"
                  name="custlabel"
                  required
                />
                ...
                <input
                  onChange={(e) => {
                    set_signup_location(e.target.value);
                  }}
                  style={{ marginBottom: "8%" }}
                  type="text"
                  name="custlabel"
